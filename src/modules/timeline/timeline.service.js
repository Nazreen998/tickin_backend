...
const TABLE_ORDERS = process.env.TABLE_ORDERS || "tickin_orders";
...
export async function getOrderTimeline(req, res) {
  try {
    ...
    // ✅ query timeline from tickin_timeline
